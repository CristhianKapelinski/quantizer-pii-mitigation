...
Continuous integration runs the unit suite and the full offline replay on a clean runner, on every push and weekly, so the badge above is a live statement that the 141 published values still reproduce on a machine with none of the authors' state.
